...
var_typescript: <assoc=right> ID_VAR COLON TYPE_IDENTIFIER (ASSIGN expr)? # attributesDeclaration;
...
expr: expr(AT TYPE_IDENTIFIER)? PERIOD ID_VAR LPAREN ( expr (COMMA expr)*)* RPAREN # methodCall
